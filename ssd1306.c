 ...
 * modification for NRF52832: Murat Okumus<okumusmurat74@gmail.com>
   ...
   ----------------------------------------------------------------------
    Copyright (C) Tilen Majerle, 2023
...
/* Write command */
#define SSD1306_WRITECOMMAND(command)      I2C0_Write(SSD1306_I2C_ADDR, 0x00, (command))
/* Write data */
#define SSD1306_WRITEDATA(data)            I2C0_Write(SSD1306_I2C_ADDR, 0x40, (data))
/* Absolute value */
#define ABS(x)   ((x) > 0 ? (x) : -(x))

/* SSD1306 data buffer */
static int8_t SSD1306_Buffer[SSD1306_WIDTH * SSD1306_HEIGHT / 8];
...
void SSD1306_GotoXY(int32_t x, int32_t y)
{
    /* Set write pointers */
    SSD1306.CurrentX = x;
    SSD1306.CurrentY = y;
